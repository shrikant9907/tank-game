...
export default function Page() {
  return (
    <LegalLayout title="Refund and Cancellation Policy">
        ...
        <p style={styles.p}>Tankar Battle is currently free to play and does not sell paid gameplay, in-game currency, upgrades, subscriptions, prizes, or downloadable paid content.</p>
        <ul>
          <li style={styles.li}>Because no payment is collected in this version, refunds and cancellations do not apply.</li>
          <li style={styles.li}>If paid features are added later, pricing, cancellation, refund, taxes, and support terms must be published before taking payment.</li>
          <li style={styles.li}>Any future payment feature should use a compliant payment provider and clear user consent.</li>
        </ul>
