...
export default function Page() {
  return (
    <LegalLayout title="Disclaimer">
        ...
        <p style={styles.p}>Tankar Battle is an arcade-style fictional game. It does not represent real combat, real weapons training, military instruction, gambling, investment, or financial activity.</p>
        <ul>
          <li style={styles.li}>The game is provided for entertainment and learning/demo purposes.</li>
          <li style={styles.li}>No real-world reward, earning, or winning is promised.</li>
          <li style={styles.li}>Legal and compliance requirements can change. These policy pages are starter templates and should be reviewed by a qualified legal professional before public commercial launch.</li>
        </ul>
